...
import { Button, Checkbox, createMuiTheme, FormControlLabel, Grid, Link, makeStyles, ThemeProvider } from '@material-ui/core';
...
const renderFromHelper = ({ touched, error }: IRenderFormHelperProps) => {
  ...
  const DecoratedLogin = connect(mapStateToProps, mapDispatchToProps)(Loging);
